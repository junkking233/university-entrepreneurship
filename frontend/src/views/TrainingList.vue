...
async function fetchList() {
  ...
  try {
    ...
    trainingList.value = [
      { id: 1, title: '创业计划书撰写技巧', speaker: '张教授', time: '2024-06-15 14:00', location: '大学生活动中心301', status: 'upcoming', enrolled: 45, capacity: 100 },
      { id: 2, title: '商业模式创新工作坊', speaker: '李总', time: '2024-06-20 09:30', location: '创新创业学院报告厅', status: 'upcoming', enrolled: 78, capacity: 80 },
      { id: 3, title: '融资路演实战演练', speaker: '王导师', time: '2024-06-28 14:00', location: '科技园路演大厅', status: 'ongoing', enrolled: 120, capacity: 150 }
    ]
    pagination.total = 3
  } finally {
    loading.value = false
